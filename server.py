class Server:
    ...
    relations = {
        "python": "Python is a programming language developed in 1998 by Guido Van Rossum",
    ...
    def request(self, input):
        input.lower()
        for key in self.relations.items():
            print(key, 'corresponds to', self.relations.items()[key])
